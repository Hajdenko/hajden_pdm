...
Config.Categories = {
    {
        ...
        icon = "bars",
        iconColor = "#ffffff",
        job = "police", -- will only display the category to certain jobs, no need for having job for each car if this is set.
        vehicles = {
            {
                name = "Adder", model = "adder", 
                icon = "bars", iconColor = "#ffffff", 
                price = 100000, description = "This is a description",
                job = "police", -- will only display the car to certain jobs
    ...
    { -- example category with minimal features (every feature in this is required)
        name = "SUVs",
        vehicles = {
